...
class StudentModelService:
    ...
    def get_or_create_student(self, user_id: str, username: Optional[str] = None) -> Student:
        """获取或创建学生"""
    ...
    def get_mastery(self, student_id: int, skill_id: str) -> Optional[StudentMastery]:
        """获取某个知识点的掌握度"""
    ...
    def update_mastery_from_answer(
        ...
        """根据答题结果更新掌握度"""
        # 获取题目关联的知识点
        question_skills = self.db.query(QuestionSkill).filter(
    ...
    def get_learning_report(self, student_id: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_correct_rate": (
                ...
                if student.total_questions > 0 else 0.0
            ),
        }
